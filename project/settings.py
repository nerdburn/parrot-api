...
AWS_ACCESS_KEY_ID = get('BUCKETEER_AWS_ACCESS_KEY_ID')
AWS_SECRET_ACCESS_KEY = get('BUCKETEER_AWS_SECRET_ACCESS_KEY')
AWS_STORAGE_BUCKET_NAME = get('BUCKETEER_AWS_STORAGE_BUCKET_NAME')
AWS_LOCATION = get('BUCKETEER_AWS_LOCATION')
AWS_DEFAULT_REGION = get('BUCKETEER_AWS_DEFAULT_REGION')
